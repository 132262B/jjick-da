...
Este es un servicio desarrollado para aumentar la tasa de aprobación de los usuarios en exámenes de tipo banco de preguntas.

Puede encontrar más detalles sobre el proyecto a través de la [WIKI](https://github.com/132262B/jjick-da/wiki).

__Periodo del proyecto:__ 15 de octubre de 2022 ~ 13 de diciembre de 2022 (Finalizado)
...
[5. Ver contenido desarrollado (GIF)](https://github.com/132262B/jjick-da/wiki/%EA%B0%9C%EB%B0%9C%EB%90%9C-%EB%82%B4%EC%9A%A9-%EB%B3%B4%EA%B8%B0(GIF)) <br>
[6. Diseño de Pantallas](https://github.com/132262B/jjick-da/wiki/%ED%99%94%EB%A9%B4-%EC%84%A4%EA%B3%84%EC%84%9C)
...
<table>
    ...
    <tr>
        <td>Kwon Jun-ho (igor)</td>
        <td>Lee Ji-cheol (AKANY99)</td>
        <td>Hwang Jung-min (realomadia)</td>
    </tr>
    <tr>
        <td>Desarrollo de módulos comunes, PL</td>
        <td>Desarrollo de páginas de usuario</td>
        <td>Desarrollo de página de administrador</td>
    </tr>
</table>
...
## Diagrama de Configuración del Servidor
